...
passwordgenerator()
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto px-4 my-8 py-3 text-orange-500 shadow-md rounded-lg bg-gray-800'>
      <h1 className='text-center text-white text-xl py-3 '>password generator</h1>
     <div className='flex shadow rounded-lg overflow-hidden mb-4'>
      ...
      readOnly
      ref={passwordref}/>
      <button onClick={copypassword} className='bg-blue-700 py-2.5 px-3 text-white shrink-0 outline-none'>copy</button>
     </div>
     ...
     <div className='flex text-sm gap-x-7'>
      ...
      <div className='flex items-center gap-x-1'>
        <input 
        type="checkbox" defaultChecked={charallowed} id='numberinput' onChange={()=>{
